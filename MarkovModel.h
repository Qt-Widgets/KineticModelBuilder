...
public:
    // Default constructor.
    Variable(QObject *parent = 0) : QObject(parent), _isConst(true), _min(0), _max(0), _isNumber(false) {}
...
public:
    // Default constructor.
    State(QObject *parent = 0) : QObject(parent), _probability("0"), _index(-1) {}
...
public:
    // Default constructor.
    Transition(State *from = 0, State *to = 0, QObject *parent = 0) :
...
public:
    // Default constructor.
    BinaryElement(QObject *parent = 0) : QObject(parent), _probability0("1"),
        _rate01("10"), _rate10("10"), _charge01("0"), _charge10("0"), _index(-1) {}
...
public:
    // Default constructor.
    Interaction(BinaryElement *A = 0, BinaryElement *B = 0, QObject *parent = 0) :
...
public:
    // Default constructor.
    StateGroup(QObject *parent = 0) : QObject(parent), _isActive(true) {}
