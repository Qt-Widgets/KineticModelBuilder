...
MarkovModel::MarkovModel(QObject *parent) :
    QObject(parent)
{
    _factory.registerCreator("Variable", _createObject<Variable>);
    _factory.registerCreator("State", _createObject<State>);
    _factory.registerCreator("Transition", _createObject<Transition>);
    _factory.registerCreator("BinaryElement", _createObject<BinaryElement>);
    _factory.registerCreator("Interaction", _createObject<Interaction>);
    _factory.registerCreator("StateGroup", _createObject<StateGroup>);
}
...
void test()
{
    ...
    MarkovModel model;
    Variable *x = new Variable(&model);
    Variable *y = new Variable(&model);
    State *A = new State(&model);
    State *B = new State(&model);
    Transition *AB = new Transition(A, B, &model);
    Transition *BA = new Transition(B, A, &model);
    ...
    BinaryElement *C = new BinaryElement(&model);
    BinaryElement *D = new BinaryElement(&model);
    Interaction *CD = new Interaction(C, D, &model);
    StateGroup *G = new StateGroup(&model);
