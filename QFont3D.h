...
#ifndef __QFont3D_H__
#define __QFont3D_H__
...
{
public:
    QFont3D() : _font(QFont()), _displayListBase(0), _numGlyphs(0) {}
    ~QFont3D() { if(_displayListBase) glDeleteLists(_displayListBase, _numGlyphs); }
