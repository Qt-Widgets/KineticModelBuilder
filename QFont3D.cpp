...
void QFont3D::setFont(const QFont &font, float glyphThickness, int numGlyphs)
{
    if(_displayListBase)
...
void QFont3D::print(const QString &text, const QVector3D &position, int flags, float scale) const
{
    glPushMatrix();
...
void QFont3D::_buildGlyph(int glyph, GLuint displayListBase, const QFont &font, QFontMetricsF *fontMetrics, float glyphThickness)
{
    QPainterPath path;
